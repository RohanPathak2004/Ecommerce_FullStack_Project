...
console.log(id);
    ...
    return (
        <div className="w-full   md:flex justify-center md:items-center">
            <form onSubmit={handleFormSubmission} className="max-w-[90vw] md:px-4 md:grid md:grid-cols-1 md:justify-center md:gap-6 md:min-w-[70%] md:items-center flex flex-col gap-2 text-gray-700 md:mb-5">
                ...
                <div className="shadow-2xs flex flex-col gap-1">
                    ...
                    <div className="px-2 border-black rounded-sm w-full aspect-square justify-center items-center h-[200px]">
                    ...
                    <input className="placeholder-blue-800  min-h-1/2 text px-2 rounded-sm bg-blue-200
                     py-1 outline-neutral-700 border-gray-700 focus-within:outline-2
                      focus-within:-outline-offset-2 focus-within:outline-indigo-500" onChange={(e)=>onChangeImageHandler(e.target.files[0])}
                ...
                <div className="shadow-2xs flex flex-col gap-0">
                    ...
                    <input className=" md:w-full min-h-1/2 md: text px-2 rounded-sm bg-blue-200
                     py-1 outline-neutral-700 border-gray-700 focus-within:outline-2
                      focus-within:-outline-offset-2 focus-within:outline-indigo-500 " type={'date'} max={new Date().toISOString().split('T')[0]}
                           name={'releaseDate'}
                           onChange={(e)=>onChangeHandler(e)}
                ...
                <div className="shadow-2xs flex flex-col gap-0">
                    ...
                    <input  className=" md:w-full min-h-1/2 md: text px-2 rounded-sm bg-blue-200
                     py-1 outline-neutral-700 border-gray-700 focus-within:outline-2
                      focus-within:-outline-offset-2 focus-within:outline-indigo-500 "  type={"number"} min={'0'} step={1}
                            name={'stockQuantity'}
                ...
                <button type={'submit'} className="px-4 py-2 bg-orange-400 text-white max-w-1/3 rounded-md "  >Update</button>
                </div>
            </form>
            <ToastContainer/>
        </div>
